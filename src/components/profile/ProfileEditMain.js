...
export const ProfileEditMain = (data) => {
  ...
  return (
    ...
    {image? <img src={URL.createObjectURL(image)} alt='img'></img>: <img src={process.env.REACT_APP_PUBLIC_FOLDER +userProfile.profilePicture} alt='profile-img'></img>}
   
    
    </div>
    <button onClick={() => imageRef.current.click()} type="button">change Image</button>
    <div className='edit-profile-banner-change'>
    {coverImage? <img src={URL.createObjectURL(coverImage)} alt='img'></img>: <img src={process.env.REACT_APP_PUBLIC_FOLDER +userProfile.coverPicture} alt='profile-img'></img>}
   
    
    </div>
    <button onClick={() => coverImageRef.current.click()} type="button">change Image</button>
    ...
    <div style={{ display: "none" }}>
          ...
          <div style={{ display: "none" }}>
            <input type="file" ref={coverImageRef} onChange={onCoverImageChange} />
          </div>
    </form>
    </div>
  )
