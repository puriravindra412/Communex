          ...
          <div className="container-top-new">
            <div className="buttons-container">
              <div>
                ...
                <button
                  className={activeCategory === "Recent Posts" ? "active" : ""}
                  onClick={() => handleCategoryChange("Recent Posts")}
                >
                  Recent Posts
                </button>
                <button
                  className={activeCategory === "Blogs" ? "active" : ""}
                ...
                <button
                  className={
                    activeCategory === "Tags You follow" ? "active" : ""
                  }
                  onClick={() => handleCategoryChange("Tags You follow")}
                >
                  Tags You follow
                </button>
              </div>
