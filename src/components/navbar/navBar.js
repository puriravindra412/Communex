...
const NavBar = () => {
  ...
  const switchMode = () => {
    dispatch(
      updateTheme(theme.theme === "lightmode" ? "darkmode" : "lightmode"),
    );
  };
    ...
    <div>
      <div className="nav-container">
        ...
        <div className="icon-wrapper">
          <button className="icon-menu" onClick={() => switchMode()}>
            {theme.theme === "lightmode" ? <CiDark /> : <CiLight />}
          </button>
        ...
        <button className="icon-menu-small" onClick={() => switchMode()}>
          {theme.theme === "lightmode" ? <CiDark /> : <CiLight />}
        </button>
        <Link to="/chat-mobile">
          <button className="icon-menu-small">
            <RiMessengerLine />
          </button>
        </Link>
        <div className="small-menu">
          <button className="small-menu-button" onClick={() => showMenu()}>
            {" "}
            {isOpen && <IoMenuOutline />}
          </button>
          <div className={style}>
            {" "}
            <MobileMenu showMenu={showMenu} />
