         ...
         <img src={Logo} alt="logo"  />
            <div className='login-box-main'>
                <div className='login-left-box'>
                    ...
                    <p className='heading'><Typewriter
                    options={{
                      strings: [
               ...
               <div className='login-right-box'>
                          {div==='login'?<Logincard/>:<Signup/>}
                           ...
                           <div className='sign-up-link' >
                                        <span>dont have an account ?</span> <button  className='sign-up' onClick={()=>showDiv()} > Sign up</button>
                             </div>:
                             <div className='sign-up-link' >
                                        <span>alreday have an account ?</span> <button  className='sign-up' onClick={()=>showDiv()} > log in</button>
                             </div>
                            }
               </div>
