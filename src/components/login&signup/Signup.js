...
export const Signup = () => {
  ...
  const onSubmit= (data) => {
  if(data.password===data.confirmpassword){dispatch(signUp(data))}
  }
  ...
  return (
    <div className='login-right-box'>
                    ...
                    <form className='login-form' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type='text' placeholder="firstname"{...register('firstname')} required></input>
                        ...
                        <input type='text' placeholder="Confirmpassword" {...register('confirmpassword')}></input>
