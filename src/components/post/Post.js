...
import CommentEditor from "../home/CommentEditor";
    ...
    <div className="postbox">
      ...
      <div className="post-container-box">
        <img
          src={
            data.BannerImage
              ? process.env.REACT_APP_PUBLIC_FOLDER + data.BannerImage
              : ""
          }
          alt={"Banner"}
          className="post-image-banner"
        ></img>
        <h1>{data.heading}</h1>
        <div
          className="prose lg:prose-xl html-content "
          dangerouslySetInnerHTML={{ __html: data.desc }}
        ></div>
        <div className="like-comment-box post">
        ...
        {comments ? (
          <div className="comment-list post">
            <ul>
              {data.comments.slice(0, 3).map((item, id) => {
                return (
                  <li key={id}>
